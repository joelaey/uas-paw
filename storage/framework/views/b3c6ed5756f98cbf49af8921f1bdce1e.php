            ...
            <div class="w-full max-w-md px-8" x-data="{ show: false, remember: true }">
                ...
                <form method="POST" action="<?php echo e(route('login')); ?>">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="email" name="email" value="<?php echo e(old('email')); ?>" placeholder="Masukan email"
...
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/muhammadagungjulyansyah/Documents/Kuliah/Semester 5/PAW/project-uas/project-paw/resources/views/auth/login.blade.php ENDPATH**/ ?>