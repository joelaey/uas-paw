        ...
        <svg x-show="show" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5"
            ...
            <div class="flex items-center justify-between mb-6">
                <label class="flex items-center gap-2 text-sm cursor-pointer">
                    <input type="checkbox" x-model="remember" class="hidden">
                    <span
            ...
            <!-- Button -->
            <button class="w-full bg-gray-800 text-white py-3 rounded-full text-lg font-medium hover:bg-gray-900 transition">
                Login
            </button>
...
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Ramadan\Downloads\Projects\pengaduan-masyarakat\resources\views/auth/login.blade.php ENDPATH**/ ?>