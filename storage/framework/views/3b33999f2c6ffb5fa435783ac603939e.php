...
<?php $__env->startSection('content'); ?>
    ...
    <form method="POST" action="<?php echo e(route('user.profile.update')); ?>" enctype="multipart/form-data"
        ...
        <div class="flex flex-col items-center mb-10" x-data="{ preview: null }">
            <div class="relative">
                <img :src="preview || '<?php echo e($user->avatar ? asset('storage/' . $user->avatar) : 'https://i.pravatar.cc/128?u=' . $user->id); ?>'"
...
<?php echo $__env->make('user.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/muhammadagungjulyansyah/Documents/Kuliah/Semester 5/PAW/project-uas/project-paw/resources/views/user/profile.blade.php ENDPATH**/ ?>