    ...
    <div class="flex min-h-screen">
        ...
        <aside class="w-64 bg-[#8FA6C9] text-white flex flex-col">
            ...
            <div class="flex items-center gap-3 px-6 py-5 border-b border-white/20">
                <img src="<?php echo e(asset('images/logo.png')); ?>" class="w-10 h-10 rounded-full" alt="Logo">
                <div>
            ...
            <nav class="flex-1 px-4 py-6 space-y-2">
                ...
                <!-- Pengaduan -->
                <a href="<?php echo e(url('/admin/pengaduan')); ?>"
                    class="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-white/20 transition">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            ...
            <div class="flex items-center justify-between mb-8">
                <div>
                    ...
                    <p class="text-gray-500 text-sm">
                        <?php echo e(now()->format('H:i')); ?> - <?php echo e(now()->translatedFormat('d F Y')); ?>
                ...
                <div class="flex items-center gap-4">
                    ...
                    <!-- Avatar -->
                    <img src="<?php echo e(asset('images/avatar.png')); ?>" class="w-10 h-10 rounded-full border" alt="Admin">
                </div>
            </div>
...
</html><?php /**PATH /Users/muhammadagungjulyansyah/Documents/Kuliah/Semester 5/PAW/project-uas/project-paw/resources/views/admin/layout.blade.php ENDPATH**/ ?>