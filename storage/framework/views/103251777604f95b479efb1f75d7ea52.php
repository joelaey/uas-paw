...
<?php $__env->startSection('content'); ?>
    <div class="flex min-h-screen">
        ...
        <div class="hidden lg:flex w-1/2 bg-[#8FA6C9] relative p-16 text-white">
            ...
            <img src="<?php echo e(asset('images/ilustrasi.png')); ?>" class="absolute bottom-10 left-10 w-[420px]" />
        </div>
...
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/muhammadagungjulyansyah/Documents/Kuliah/Semester 5/PAW/project-uas/project-paw/resources/views/auth/verify.blade.php ENDPATH**/ ?>