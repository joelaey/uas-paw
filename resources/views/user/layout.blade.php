    ...
    <div class="flex min-h-screen">
        ...
        <aside class="w-72 bg-[#C9D7EE] rounded-tr-[40px] rounded-br-[40px] p-6 flex flex-col">
            ...
            <nav class="space-y-3 flex-1">
                <a href="{{ route('user.dashboard') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-white transition
               {{ request()->routeIs('user.dashboard') ? 'bg-white shadow' : '' }}">
                ...
                <a href="{{ route('user.pengaduan') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-white transition
               {{ request()->routeIs('user.pengaduan') ? 'bg-white shadow' : '' }}">
                ...
                <a href="{{ route('user.riwayat') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-white transition
               {{ request()->routeIs('user.riwayat') ? 'bg-white shadow' : '' }}">
                ...
                <a href="{{ route('user.profile') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-white transition
